    ...
    <form wire:submit='addStudent'>
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input id="name" type="email" placeholder="Enter student email" wire:model="form.email"
                    class="appearance-none block w-full bg-gray-200 text-gray-700 rounded py-3 px-4 mb-3 leading-tight
                        @error('form.email')
                            border-red-300 text-red-900 focus:border-red-500 focus:ring-red-500
                        @enderror
        ...
        <div class="flex justify-between">
            ...
            {{-- <button wire:click="resetForm"
                class="p-2 text-white bg-gray-800 rounded-lg hover:bg-gray-600">Reset</button> --}}
